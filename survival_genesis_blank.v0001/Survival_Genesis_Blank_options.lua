options = 
{
	{ 
		...
		values = { 
			{text = "Standard",						help = "The classic wave Survival mode", key = 1, },
			{text = "No Point Defense (Unit Survival)",	help = "No point defense turrets, only units can be used to protect your base. Based on Unit Survival (Hard)", key = 2, },
			{text = "Paragon Only",					help = "One paragon to share resources between all Commanders plus resource fabrication (Hard)", key = 3, }, 
			{text = "Reclaim Only",					help = "All mass has to be gathered through reclaim or mass fabrication, Recommended All Factions set to ACUs and the Reclaim Turret Mod (Very Hard)", key = 4, },
			{text = "Experimental Factory",		help = "Only Specially modified Experimental units will spawn. Based on Survival Expiremental Factory", key = 5, },
			{text = "RNG Mode",					help = "Totally random units are spawned, including expirementals. Good Luck", key = 6, },
			{text = "Mod units Only",					help = "Only mod units will spawn, requires supported mods to work.", key = 7, },
		}, 
	},
	{ 
		default = 5, 
